    ...
    return (
     ...
     <div className="flex flex-col sm:flex-row flex-wrap justify-center leading-relaxed max-w-[900px] text-sm sm:text-base lg:text-lg space-y-4 sm:space-y-0 text-justify">
         <p className=" py-1 px-2 sm:px-4 ">
             يقدم معهد اللغات دورات تعليم اللغة الأنجليزية بمستوياتها المختلفة
             <span dir="ltr" className="inline-block"> (HSK)</span>
             ، المعتمدة دوليًا ، إحدى أعرق المؤسسات الأكاديمية في تعليم اللغة والثقافة الأنجليزية. تغطي هذه الدورات جميع مستويات
             <span dir="ltr" className="inline-block"> HSK</span>
             (من
             <span dir="ltr" className="inline-block"> HSK 1 </span>
             للمبتدئين إلى
             <span dir="ltr" className="inline-block"> HSK 6</span>
             للمحترفين)، وهي الشهادة المعيارية المُعترف بها عالميًا لتقييم كفاءة اللغة الأنجليزية لغير الناطقين بها.
         </p>
         <p className="py-1 sm:px-4 ">
             ...
             <span dir="ltr" className="inline-block"> HSK</span>
             بامتياز. يتميز البرنامج بفريق تدريسي متخصص بخبرة واسعة في تعليم اللغة الأنجليزية، بالإضافة إلى تقديم خطط تعلم فردية تناسب احتياجات وأهداف كل متعلم، سواء كانت أكاديمية أو مهنية. الجمع بين الاعتماد الدولي، المنهاج المتكامل، والدعم الشخصي يجعل هذه الدورات الخيار الأمثل لإتقان اللغة الأنجليزية.
         </p>
