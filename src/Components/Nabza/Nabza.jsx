...
// const ChineseLanguageIntro = () => {
//     return (
//         <div className="min-h-screen flex flex-col items-center py-16" dir="rtl">
//             {/* العنوان */}
//             <h1 className="text-3xl font-bold mb-4 text-center text-[#855D00]">نبذة عن تعليم اللغة الصينية</h1>

//             {/* الخط الأفقي */}
//             <hr className="w-80 border-[#855D00] border-t-2 mb-6" />

//             {/* النص */}
//             <div className="flex flex-wrap justify-center leading-relaxed max-w-5xl text-center">
//                 <p>
...
//                     يعتمد المنهاج على تطوير مهارات القراءة، الكتابة، الاستماع، والتحدث، مع تركيز خاص على إعداد المتعلمين لاجتياز اختبارات
//                     <span dir="ltr" className="inline-block"> HSK</span>
...
//             {/* من نحن */}
//             <h1 className="text-3xl font-bold my-4 text-center text-[#855D00]">من نحن</h1>

//             {/* الخط الأفقي */}
//             <hr className="w-28 border-[#855D00] border-t-2 mb-6" />

//             <div className="flex flex-wrap justify-center leading-relaxed max-w-5xl">
//                 <p className="mb-2 text-center">
//                 "معهد بعد للغات" هو مؤسسة تعليمية ناشئة (Plus Boud) متخصصة في تقديم خدمات تعليمية مبتكرة لتعليم اللغات الأجنبية، بما في ذلك الصينية، الفرنسية، والإنجليزية. يتميز المعهد برؤية مستقبلية تهدف إلى تمكين الطلاب والمتدربين من إتقان اللغات وربطها بتطوير المهارات المهنية والحياتية التي تتماشى مع احتياجات سوق العمل الحديث.
...
// export default ChineseLanguageIntro;
import React from "react";

const Nabza = () => {
    return (
        <div className="min-h-screen flex flex-col items-center py-8 sm:py-12 lg:py-16 px-4" dir="rtl">
            {/* العنوان */}
